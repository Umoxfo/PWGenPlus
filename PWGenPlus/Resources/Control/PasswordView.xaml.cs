...
namespace PWGenPlus.Resources.Control
{
    /// <summary>
    /// PasswordViewItem.xaml の相互作用ロジック
    /// </summary>
    public partial class PasswordView : ListBox
    {
        ...
        public PasswordView()
        {
            ...
            this.passwords = new ObservableCollection<Password>(Enumerable.Range(1, 100)
                .Select(x => new Password
                {
                    ActualPassword = "tanaka" + x
                }));
            this.DataContext = passwords;
        }
    }
}
